...
class OutlierDetection(BaseDefenseMethod):
    ...
    def defend_before_aggregation(
        ...
        raw_client_grad_list = self.cross_round_check.defend_before_aggregation(raw_client_grad_list, conf)
        ...
        if self.cross_round_check.is_attack_existing:
            ...
            raw_client_grad_list = self.three_sigma_check.defend_before_aggregation(raw_client_grad_list, conf)
