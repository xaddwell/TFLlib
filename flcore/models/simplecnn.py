...
class SimpleCNN(BaseModel): # for CIFAR10 experiment in McMahan et al., 2016; (https://github.com/tensorflow/tensorflow/blob/r0.11/tensorflow/models/image/cifar10/cifar10.py)
    def __init__(self, in_channels, num_classes, hidden_size=32):
